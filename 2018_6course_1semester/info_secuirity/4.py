...
# def iterate_bits(data:str):
#     """
#
#     :param data:
#     :return: # return Boole and not bits
#     """
#     for char in data:
#         bit_char = char.encode("utf-8")
#         for bit in bit_char:    # bit_char[2:] because bin out with always prefix "0b"
#             yield bit
...
def encrypt(lines:list, data:str):
