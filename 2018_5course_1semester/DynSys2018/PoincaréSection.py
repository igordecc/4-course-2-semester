...
"""
избавиться - переходный процесс
задание плоскости x=2
моделировать систему и отслеживать x: x<2? или нет? x_2<2?
при x1<2 и x2>2 - пересечение
изменить нестандартный шаг H=1 на H(x,y,z) (см. страница 96)
"""
def H(x,y,z):
    args = [x,y,z]
